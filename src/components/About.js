		...
		<div className="section" id="about">
			...
			<div className="section-content">
				<div className='about-text'>
					...
					<p>
						Currently, I work as a  <strong>Software Development Analyst</strong> at [...] where I [...].
						Previously, I was a <strong>Software Developer</strong> at the{" "}
					...
					<p>
						Beyond software development, I'm deeply passionate about education and fostering supportive spaces for people to explore tech!
						I've developed open-source Python course material, served as a Teaching Assistant for an undergraduate software course,
						and led game-based scripting classes.
					</p>
					<p>
